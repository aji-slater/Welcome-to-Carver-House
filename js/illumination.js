...
furnishGroup.forEach(function (tile) {
  ...
  if (game.physics.arcade.distanceBetween(tile, player) < 60 && game.physics.arcade.distanceBetween(tile, player) > 50) {
    tile.tint = 0xeeeeee;
  }
  if (game.physics.arcade.distanceBetween(tile, player) < 70 && game.physics.arcade.distanceBetween(tile, player) > 60) {
    tile.tint = 0xdddddd;
  }
  if (game.physics.arcade.distanceBetween(tile, player) < 80 && game.physics.arcade.distanceBetween(tile, player) > 70) {
    tile.tint = 0xcccccc;
  }
  if (game.physics.arcade.distanceBetween(tile, player) < 90 && game.physics.arcade.distanceBetween(tile, player) > 80) {
    tile.tint = 0xbbbbbb;
  }
  if (game.physics.arcade.distanceBetween(tile, player) < 100 && game.physics.arcade.distanceBetween(tile, player) > 90) {
    tile.tint = 0xaaaaaa;
  }
